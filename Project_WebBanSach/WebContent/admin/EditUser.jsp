			...
			<table align="center" bgcolor="#CCFFCC">
				<tr>
					<td><strong><font size="6" color="#3399CC">SỬA
								THÔNG TIN NGƯỜI DÙNG</font></strong></td>
				</tr>
			</table>
			<br /> <br />
			<%--Table thong tin nguoi dung--%>
			<form id="form1" name="form1" method="post" action="UpdateUser.jsp">
				<center>
					<font size="3">Chọn tên đăng nhập người dùng cần sửa: </font> <label>
						<select name="tendn">
							<%
								try {
