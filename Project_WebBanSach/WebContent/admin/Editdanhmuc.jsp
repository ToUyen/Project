...
<body>
	<%
		...
		String group = (String) session.getAttribute("nhom");
		if (tendd != null && group.equalsIgnoreCase("1")) {
	%>
	<div id="wrap">
		...
		<div class="center_content">
			...
			<table align="center" bgcolor="#CCFFCC">
				<tr>
					<td><strong><font size="6" color="#3399CC">SỬA
								THÔNG TIN DANH MỤC</font></strong></td>
				</tr>
			</table>
			<br /> <br />
			...
			<form id="form1" name="form1" method="post"
				action="UpdateDanhMuc.jsp">
				<center>
					Chọn mã danh mục cần sửa: <label> <select name="madm">
							<%
								try {
										String searchmadm = "SELECT maDanhMucSach FROM danhmucsach";
										PreparedStatement pstmtsearchmadm = ConnectionDB
												.getConnection().prepareStatement(searchmadm);
										ResultSet rsseachmadm = pstmtsearchmadm.executeQuery();
										while (rsseachmadm.next()) {
											int madm = rsseachmadm.getInt(1);
							%>
