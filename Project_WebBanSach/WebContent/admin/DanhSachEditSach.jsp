	...
	<table align="center" border="1" border-style="solid"
		...
		<%
			String tensach = request.getParameter("tensach");
				try {
					String loadsach = "SELECT sach.id,sach.tenSach,sach.loaibia,sach.gia,sach.giaban,sach.giamgia,sach.soLuong,loaisach.tenLoaiSach,tacgia.tentacgia,nhaxuatban.tenNhaXuatBan,sach.luotbinhchon FROM sach ,loaisach ,tacgia ,nhaxuatban	WHERE sach.loaisachID = loaisach.maLoaiSach AND sach.tacgiaID = tacgia.matacgia AND  sach.nhaxbID = nhaxuatban.maNhaXuatBan AND sach.tenSach=?";
					PreparedStatement psloadsach = ConnectionDB.conn()
							.prepareStatement(loadsach);
					psloadsach.setString(1, tensach);
