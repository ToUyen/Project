 ...
 */
public class EmailPH extends HttpServlet {
	...
	private void toDo(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			Mail.sendMail("smtp.gmail.com", "chuhayotouyen@gmail.com", email, password, tieude, thongtin);
		} catch (Exception e) {
			e.printStackTrace();
			thongbao = "Gửi mail lỗi";
		}
		request.setAttribute("thongbao", thongbao);
		RequestDispatcher rd = getServletContext().getRequestDispatcher("/emaillphanhoi.jsp");
