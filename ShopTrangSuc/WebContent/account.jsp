...
<body class="metro">
	...
	<div class="contents"">
		...
		<div class="center">
			...
			<div id="formSP">
				<%
					List<SanPham> listsp = SanPhamDao.getProductAll(pages);
				...
				<div class="itemsp" style="margin-bottom: 55px;">
					...
					</label> <a href="AddSPVaoGioHang.jsp?MASP=<%=s.getMaSP()%>"
						class="chonmua" title="Thêm vào giỏ hàng"><button
							class="small">Mua</button></a>
				</div>
			...
			<%
				int soTrang = SanPhamDao.getNumberPage();
			%>
			<div class="page">
				<div class="itemp">
					<%-- <div class="itempage">
						<a href="#"><img
							src="images/icon/previous.png" /> </a>
					</div>--%>
					<%
						for(int id=1; id<=soTrang;id++){
					%>
					<a href="sanpham.jsp?page=<%=id%>"><div class="itempage"><%=id%></div></a>
					<%
						}
					%>
					<%--<div class="itempage">
						<a href="#"> <img src="images/icon/next.png" />
						</a>
					</div>--%>
				</div>
			</div>
